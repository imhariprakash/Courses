...
public class UserInput { // class for user input
    ...
    public static Scanner getScanner(File inputStream){
        try {
            return new Scanner(inputStream);
    ...
    } // Returns a scanner object for a file object
    ...
    } // Returns a scanner object for a file with the given name
    ...
    public static String getString_synchronized(){
        ...
        while(str == null || str.equals("")){
            try{
                ...
                ErrorHandle.handleError(e, "Error in getString_synchronized()");
            }
            str =sc.nextLine();
        }
        return(str);
