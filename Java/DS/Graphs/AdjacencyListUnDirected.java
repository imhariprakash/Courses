...
class AdjacencyListUnDirected{
    ...
    public static void addEdge(Node[] adjList, int src, int dest) {
        ...
        addEdgeWithOutTraversal(adjList, dest, src);
    }
    ...
    public static void removeEdges(Node[] adjList, int src, int dest) {
        if(adjList[src] == null){
            return;
        }
    ...
    public static void removeEdge(Node[] adjList, int src, int dest) {
        removeEdges(adjList, src, dest);
        removeEdges(adjList, dest, src);
    }
